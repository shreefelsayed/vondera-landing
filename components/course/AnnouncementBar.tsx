...
export default function AnnouncementBar() {
  ...
  return (
    <div className="sticky top-0 left-0 right-0 z-50 w-full bg-gradient-to-r from-primary-600 to-primary-500 text-white shadow-lg" dir="rtl">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 flex-1">
            ...
            <div className="flex flex-wrap items-center gap-2 text-sm md:text-base">
              <span className="font-bold">⚡ التسجيل المجاني ينتهي قريبًا!</span>
              <span className="hidden md:inline">سجل الآن قبل انتهاء العرض</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            <div className="flex gap-1 md:gap-2">
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1 min-w-[40px] md:min-w-[50px] text-center">
                ...
                <div className="text-[8px] md:text-xs opacity-90">يوم</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1 min-w-[40px] md:min-w-[50px] text-center">
                ...
                <div className="text-[8px] md:text-xs opacity-90">ساعة</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1 min-w-[40px] md:min-w-[50px] text-center">
                ...
                <div className="text-[8px] md:text-xs opacity-90">دقيقة</div>
              </div>
              ...
              <div className="bg-white/20 backdrop-blur-sm rounded-lg px-2 py-1 min-w-[40px] md:min-w-[50px] text-center hidden md:block">
                ...
                <div className="text-[8px] md:text-xs opacity-90">ثانية</div>
              </div>
            </div>
          </div>
